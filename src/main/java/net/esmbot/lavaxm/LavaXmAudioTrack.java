...
import com.sedmelluq.discord.lavaplayer.track.playeback.LocalAudioTrackExecutor;
...
public class LavaXmAudioTrack extends BaseAudioTrack {
    ...
    public void process(LocalAudioTrackExecutor executor) throws Exception {
        ...
        try {
            ...
            executor.executeProcessingLoop(trackProvider::providerFrames, null);
        } finally {
            trackProvider.close();
        }
    }
